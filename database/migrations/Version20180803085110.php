 ...
 */
final class Version20180803085110 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE File (id INT AUTO_INCREMENT NOT NULL, owner_id INT DEFAULT NULL, hash_crc32 VARCHAR(255) NOT NULL, createdAt DATETIME NOT NULL, size INT NOT NULL, mediaType VARCHAR(255) NOT NULL, originalFilename VARCHAR(255) NOT NULL, filename VARCHAR(255) NOT NULL, INDEX IDX_2CAD992E7E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE Measureset (id INT AUTO_INCREMENT NOT NULL, author_id INT DEFAULT NULL, siteName LONGTEXT NOT NULL, clientName LONGTEXT NOT NULL, createdAt DATE NOT NULL, authorFullName LONGTEXT NOT NULL, INDEX IDX_92AB9E3CF675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
