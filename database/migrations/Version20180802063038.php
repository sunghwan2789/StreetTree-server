...
final class Version20180802063038 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE File ADD dispositionMimeType VARCHAR(255) NOT NULL, ADD dispositionFilename VARCHAR(255) NOT NULL, DROP mimeType, DROP extension, DROP data, CHANGE filename filename VARCHAR(255) NOT NULL');
    }
